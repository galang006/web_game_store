            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="normal__breadcrumb__text">
                        <h2>Login</h2>
                        <p>Welcome to the Legend Game Store.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="login__form">
                        ...
                        if (isset($_GET['pesan'])) {
                            if ($_GET['pesan'] == "gagal") {
                                ...
                                echo "Anda harus login untuk mengkases halaman";
                            } else if ($_GET['pesan'] == "belum_login_admin") {
                                echo "Anda harus pilih login admin untuk mengkases halaman admin";
                            }
                        }
                        ?></p>
